...
class IPP_Server:
    def __init__(self):
        ...
        self.csv_file = "/home/ubuntu/protocols/IPP_decoy/IPP_gramophile.csv"
        ...
        logging.basicConfig(filename='IPP_server.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
