...
class iec_60870_Server:
    def __init__(self):
        self.HOST = self.get_ip_address()
        self.PORT = 2404
        self.gramophile_dict = {}

        self.csv_file = "/home/ubuntu/protocols/iec_60870_decoy/IEC_60870_gramophile.csv"
        ...
        logging.basicConfig(filename='iec_60870_server.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
if __name__ == "__main__":
    modbus_server = iec_60870_Server()
