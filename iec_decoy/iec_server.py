...
class iec_Server:
    def __init__(self):
        ...
        self.csv_file = "/home/ubuntu/protocols/iec_decoy/IEC_Gramophile.csv"
        ...
        logging.basicConfig(filename='iec_server.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
