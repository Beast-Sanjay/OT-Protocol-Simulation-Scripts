...
class omronServer:
    def __init__(self):
        ...
        self.csv_file = "/home/ubuntu/protocols/omron_decoy/omron_gramophile.csv"
        ...
        logging.basicConfig(filename='omron_server.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
